# Auto generated from clinical_history.yaml by pythongen.py version: 0.0.1
# Generation date: 2024-11-20T14:29:14
# Schema: soton_ibd_clinical_history
#
# id: http://w3id.org/ontogpt/soton_ibd_clinical_history
...
PATHOLOGY = CurieNamespace('pathology', 'http://w3id.org/ontogpt/soton_ibd_clinical_history')
RDF = CurieNamespace('rdf', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#')
RDFS = CurieNamespace('rdfs', 'http://www.w3.org/2000/01/rdf-schema#')
SOTON_IBD_CLINICAL_HISTORY = CurieNamespace('soton_ibd_clinical_history', 'http://w3id.org/ontogpt/soton_ibd_clinical_history/')
DEFAULT_ = SOTON_IBD_CLINICAL_HISTORY
...
class PathologyReport(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY["PathologyReport"]
    class_class_curie: ClassVar[str] = "soton_ibd_clinical_history:PathologyReport"
    class_name: ClassVar[str] = "PathologyReport"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.PathologyReport
...
class PatientClinicalHistory(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY["PatientClinicalHistory"]
    class_class_curie: ClassVar[str] = "soton_ibd_clinical_history:PatientClinicalHistory"
    class_name: ClassVar[str] = "PatientClinicalHistory"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.PatientClinicalHistory
...
class ExtractionResult(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.ExtractionResult
...
class NamedEntity(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.NamedEntity
...
class ClinicalHistoryEntity(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY["ClinicalHistoryEntity"]
    class_class_curie: ClassVar[str] = "soton_ibd_clinical_history:ClinicalHistoryEntity"
    class_name: ClassVar[str] = "ClinicalHistoryEntity"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.ClinicalHistoryEntity
...
class ClinicalHistoryLocation(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY["ClinicalHistoryLocation"]
    class_class_curie: ClassVar[str] = "soton_ibd_clinical_history:ClinicalHistoryLocation"
    class_name: ClassVar[str] = "ClinicalHistoryLocation"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.ClinicalHistoryLocation
...
class CompoundExpression(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.CompoundExpression
...
class Triple(CompoundExpression):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.Triple
...
class TextWithTriples(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.TextWithTriples
...
class TextWithEntity(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.TextWithEntity
...
class RelationshipType(NamedEntity):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.RelationshipType
...
class Publication(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.Publication
...
class AnnotatorResult(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_CLINICAL_HISTORY.AnnotatorResult
...
slots.pathologyReport__clinical_history_statements = Slot(uri=SOTON_IBD_CLINICAL_HISTORY.clinical_history_statements, name="pathologyReport__clinical_history_statements", curie=SOTON_IBD_CLINICAL_HISTORY.curie('clinical_history_statements'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.pathologyReport__clinical_history_statements, domain=None, range=Optional[Union[Union[dict, PatientClinicalHistory], List[Union[dict, PatientClinicalHistory]]]])

slots.patientClinicalHistory__clinical_history = Slot(uri=SOTON_IBD_CLINICAL_HISTORY.clinical_history, name="patientClinicalHistory__clinical_history", curie=SOTON_IBD_CLINICAL_HISTORY.curie('clinical_history'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.patientClinicalHistory__clinical_history, domain=None, range=Optional[Union[str, ClinicalHistoryEntityId]])

slots.patientClinicalHistory__clinical_history_severity = Slot(uri=SOTON_IBD_CLINICAL_HISTORY.clinical_history_severity, name="patientClinicalHistory__clinical_history_severity", curie=SOTON_IBD_CLINICAL_HISTORY.curie('clinical_history_severity'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.patientClinicalHistory__clinical_history_severity, domain=None, range=Optional[str])

slots.patientClinicalHistory__clinical_history_location = Slot(uri=SOTON_IBD_CLINICAL_HISTORY.clinical_history_location, name="patientClinicalHistory__clinical_history_location", curie=SOTON_IBD_CLINICAL_HISTORY.curie('clinical_history_location'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.patientClinicalHistory__clinical_history_location, domain=None, range=Optional[Union[str, ClinicalHistoryLocationId]])

slots.extractionResult__input_id = Slot(uri=CORE.input_id, name="extractionResult__input_id", curie=CORE.curie('input_id'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.extractionResult__input_id, domain=None, range=Optional[str])
...
slots.extractionResult__input_title = Slot(uri=CORE.input_title, name="extractionResult__input_title", curie=CORE.curie('input_title'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.extractionResult__input_title, domain=None, range=Optional[str])
...
slots.extractionResult__input_text = Slot(uri=CORE.input_text, name="extractionResult__input_text", curie=CORE.curie('input_text'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.extractionResult__input_text, domain=None, range=Optional[str])
...
slots.extractionResult__raw_completion_output = Slot(uri=CORE.raw_completion_output, name="extractionResult__raw_completion_output", curie=CORE.curie('raw_completion_output'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.extractionResult__raw_completion_output, domain=None, range=Optional[str])

slots.extractionResult__prompt = Slot(uri=CORE.prompt, name="extractionResult__prompt", curie=CORE.curie('prompt'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.extractionResult__prompt, domain=None, range=Optional[str])
...
slots.extractionResult__extracted_object = Slot(uri=CORE.extracted_object, name="extractionResult__extracted_object", curie=CORE.curie('extracted_object'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.extractionResult__extracted_object, domain=None, range=Optional[Union[dict, Any]])
...
slots.extractionResult__named_entities = Slot(uri=CORE.named_entities, name="extractionResult__named_entities", curie=CORE.curie('named_entities'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.extractionResult__named_entities, domain=None, range=Optional[Union[Union[dict, Any], List[Union[dict, Any]]]])

slots.namedEntity__id = Slot(uri=CORE.id, name="namedEntity__id", curie=CORE.curie('id'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.namedEntity__id, domain=None, range=URIRef)

slots.namedEntity__label = Slot(uri=RDFS.label, name="namedEntity__label", curie=RDFS.curie('label'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.namedEntity__label, domain=None, range=Optional[str])
...
slots.namedEntity__original_spans = Slot(uri=CORE.original_spans, name="namedEntity__original_spans", curie=CORE.curie('original_spans'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.namedEntity__original_spans, domain=None, range=Optional[Union[str, List[str]]],
                   pattern=re.compile(r'^\d+:\d+$'))

slots.triple__subject = Slot(uri=CORE.subject, name="triple__subject", curie=CORE.curie('subject'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.triple__subject, domain=None, range=Optional[Union[str, NamedEntityId]])

slots.triple__predicate = Slot(uri=CORE.predicate, name="triple__predicate", curie=CORE.curie('predicate'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.triple__predicate, domain=None, range=Optional[Union[str, RelationshipTypeId]])

slots.triple__object = Slot(uri=CORE.object, name="triple__object", curie=CORE.curie('object'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.triple__object, domain=None, range=Optional[Union[str, NamedEntityId]])

slots.triple__qualifier = Slot(uri=CORE.qualifier, name="triple__qualifier", curie=CORE.curie('qualifier'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.triple__qualifier, domain=None, range=Optional[str])
...
slots.triple__subject_qualifier = Slot(uri=CORE.subject_qualifier, name="triple__subject_qualifier", curie=CORE.curie('subject_qualifier'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.triple__subject_qualifier, domain=None, range=Optional[Union[str, NamedEntityId]])
...
slots.triple__object_qualifier = Slot(uri=CORE.object_qualifier, name="triple__object_qualifier", curie=CORE.curie('object_qualifier'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.triple__object_qualifier, domain=None, range=Optional[Union[str, NamedEntityId]])
...
slots.textWithTriples__publication = Slot(uri=CORE.publication, name="textWithTriples__publication", curie=CORE.curie('publication'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.textWithTriples__publication, domain=None, range=Optional[Union[dict, Publication]])

slots.textWithTriples__triples = Slot(uri=CORE.triples, name="textWithTriples__triples", curie=CORE.curie('triples'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.textWithTriples__triples, domain=None, range=Optional[Union[Union[dict, Triple], List[Union[dict, Triple]]]])
...
slots.textWithEntity__publication = Slot(uri=CORE.publication, name="textWithEntity__publication", curie=CORE.curie('publication'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.textWithEntity__publication, domain=None, range=Optional[Union[dict, Publication]])

slots.textWithEntity__entities = Slot(uri=CORE.entities, name="textWithEntity__entities", curie=CORE.curie('entities'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.textWithEntity__entities, domain=None, range=Optional[Union[Union[str, NamedEntityId], List[Union[str, NamedEntityId]]]])

slots.publication__id = Slot(uri=CORE.id, name="publication__id", curie=CORE.curie('id'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.publication__id, domain=None, range=Optional[str])

slots.publication__title = Slot(uri=CORE.title, name="publication__title", curie=CORE.curie('title'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.publication__title, domain=None, range=Optional[str])

slots.publication__abstract = Slot(uri=CORE.abstract, name="publication__abstract", curie=CORE.curie('abstract'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.publication__abstract, domain=None, range=Optional[str])
...
slots.publication__combined_text = Slot(uri=CORE.combined_text, name="publication__combined_text", curie=CORE.curie('combined_text'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.publication__combined_text, domain=None, range=Optional[str])

slots.publication__full_text = Slot(uri=CORE.full_text, name="publication__full_text", curie=CORE.curie('full_text'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.publication__full_text, domain=None, range=Optional[str])
...
slots.annotatorResult__subject_text = Slot(uri=CORE.subject_text, name="annotatorResult__subject_text", curie=CORE.curie('subject_text'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.annotatorResult__subject_text, domain=None, range=Optional[str])

slots.annotatorResult__object_id = Slot(uri=CORE.object_id, name="annotatorResult__object_id", curie=CORE.curie('object_id'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.annotatorResult__object_id, domain=None, range=Optional[str])
...
slots.annotatorResult__object_text = Slot(uri=CORE.object_text, name="annotatorResult__object_text", curie=CORE.curie('object_text'),
                   model_uri=SOTON_IBD_CLINICAL_HISTORY.annotatorResult__object_text, domain=None, range=Optional[str])
