# Auto generated from macroscopic_findings.yaml by pythongen.py version: 0.0.1
# Generation date: 2024-11-20T14:29:58
# Schema: soton_ibd_macroscopic_findings
#
# id: http://w3id.org/ontogpt/soton_ibd_macroscopic_findings
...
PATHOLOGY = CurieNamespace('pathology', 'http://w3id.org/ontogpt/soton_ibd_macroscopic_findings')
RDF = CurieNamespace('rdf', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#')
RDFS = CurieNamespace('rdfs', 'http://www.w3.org/2000/01/rdf-schema#')
SOTON_IBD_MACROSCOPIC_FINDINGS = CurieNamespace('soton_ibd_macroscopic_findings', 'http://w3id.org/ontogpt/soton_ibd_macroscopic_findings/')
DEFAULT_ = SOTON_IBD_MACROSCOPIC_FINDINGS
...
class PathologyReport(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS["PathologyReport"]
    class_class_curie: ClassVar[str] = "soton_ibd_macroscopic_findings:PathologyReport"
    class_name: ClassVar[str] = "PathologyReport"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.PathologyReport
...
class PathologyStatement(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS["PathologyStatement"]
    class_class_curie: ClassVar[str] = "soton_ibd_macroscopic_findings:PathologyStatement"
    class_name: ClassVar[str] = "PathologyStatement"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.PathologyStatement
...
class ExtractionResult(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.ExtractionResult
...
class NamedEntity(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.NamedEntity
...
class Diagnosis(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS["Diagnosis"]
    class_class_curie: ClassVar[str] = "soton_ibd_macroscopic_findings:Diagnosis"
    class_name: ClassVar[str] = "Diagnosis"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.Diagnosis
...
class AnatomicalEntity(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS["AnatomicalEntity"]
    class_class_curie: ClassVar[str] = "soton_ibd_macroscopic_findings:AnatomicalEntity"
    class_name: ClassVar[str] = "AnatomicalEntity"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.AnatomicalEntity
...
class AnatomicalStructures(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS["AnatomicalStructures"]
    class_class_curie: ClassVar[str] = "soton_ibd_macroscopic_findings:AnatomicalStructures"
    class_name: ClassVar[str] = "AnatomicalStructures"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.AnatomicalStructures
...
class CompoundExpression(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.CompoundExpression
...
class Triple(CompoundExpression):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.Triple
...
class TextWithTriples(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.TextWithTriples
...
class TextWithEntity(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.TextWithEntity
...
class RelationshipType(NamedEntity):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.RelationshipType
...
class Publication(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.Publication
...
class AnnotatorResult(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_MACROSCOPIC_FINDINGS.AnnotatorResult
...
slots.pathologyReport__pathology_statements = Slot(uri=SOTON_IBD_MACROSCOPIC_FINDINGS.pathology_statements, name="pathologyReport__pathology_statements", curie=SOTON_IBD_MACROSCOPIC_FINDINGS.curie('pathology_statements'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.pathologyReport__pathology_statements, domain=None, range=Optional[Union[Union[dict, PathologyStatement], List[Union[dict, PathologyStatement]]]])

slots.pathologyStatement__diagnosis = Slot(uri=SOTON_IBD_MACROSCOPIC_FINDINGS.diagnosis, name="pathologyStatement__diagnosis", curie=SOTON_IBD_MACROSCOPIC_FINDINGS.curie('diagnosis'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.pathologyStatement__diagnosis, domain=None, range=Optional[Union[str, DiagnosisId]])

slots.pathologyStatement__qualifiers = Slot(uri=SOTON_IBD_MACROSCOPIC_FINDINGS.qualifiers, name="pathologyStatement__qualifiers", curie=SOTON_IBD_MACROSCOPIC_FINDINGS.curie('qualifiers'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.pathologyStatement__qualifiers, domain=None, range=Optional[Union[str, List[str]]])

slots.pathologyStatement__severity = Slot(uri=SOTON_IBD_MACROSCOPIC_FINDINGS.severity, name="pathologyStatement__severity", curie=SOTON_IBD_MACROSCOPIC_FINDINGS.curie('severity'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.pathologyStatement__severity, domain=None, range=Optional[str])

slots.pathologyStatement__anatomical_entities = Slot(uri=SOTON_IBD_MACROSCOPIC_FINDINGS.anatomical_entities, name="pathologyStatement__anatomical_entities", curie=SOTON_IBD_MACROSCOPIC_FINDINGS.curie('anatomical_entities'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.pathologyStatement__anatomical_entities, domain=None, range=Optional[Union[Union[str, AnatomicalEntityId], List[Union[str, AnatomicalEntityId]]]])

slots.pathologyStatement__anatomical_structure = Slot(uri=SOTON_IBD_MACROSCOPIC_FINDINGS.anatomical_structure, name="pathologyStatement__anatomical_structure", curie=SOTON_IBD_MACROSCOPIC_FINDINGS.curie('anatomical_structure'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.pathologyStatement__anatomical_structure, domain=None, range=Optional[Union[Union[str, AnatomicalStructuresId], List[Union[str, AnatomicalStructuresId]]]])

slots.pathologyStatement__negative = Slot(uri=SOTON_IBD_MACROSCOPIC_FINDINGS.negative, name="pathologyStatement__negative", curie=SOTON_IBD_MACROSCOPIC_FINDINGS.curie('negative'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.pathologyStatement__negative, domain=None, range=Optional[str])

slots.extractionResult__input_id = Slot(uri=CORE.input_id, name="extractionResult__input_id", curie=CORE.curie('input_id'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.extractionResult__input_id, domain=None, range=Optional[str])
...
slots.extractionResult__input_title = Slot(uri=CORE.input_title, name="extractionResult__input_title", curie=CORE.curie('input_title'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.extractionResult__input_title, domain=None, range=Optional[str])
...
slots.extractionResult__input_text = Slot(uri=CORE.input_text, name="extractionResult__input_text", curie=CORE.curie('input_text'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.extractionResult__input_text, domain=None, range=Optional[str])
...
slots.extractionResult__raw_completion_output = Slot(uri=CORE.raw_completion_output, name="extractionResult__raw_completion_output", curie=CORE.curie('raw_completion_output'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.extractionResult__raw_completion_output, domain=None, range=Optional[str])

slots.extractionResult__prompt = Slot(uri=CORE.prompt, name="extractionResult__prompt", curie=CORE.curie('prompt'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.extractionResult__prompt, domain=None, range=Optional[str])
...
slots.extractionResult__extracted_object = Slot(uri=CORE.extracted_object, name="extractionResult__extracted_object", curie=CORE.curie('extracted_object'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.extractionResult__extracted_object, domain=None, range=Optional[Union[dict, Any]])
...
slots.extractionResult__named_entities = Slot(uri=CORE.named_entities, name="extractionResult__named_entities", curie=CORE.curie('named_entities'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.extractionResult__named_entities, domain=None, range=Optional[Union[Union[dict, Any], List[Union[dict, Any]]]])

slots.namedEntity__id = Slot(uri=CORE.id, name="namedEntity__id", curie=CORE.curie('id'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.namedEntity__id, domain=None, range=URIRef)

slots.namedEntity__label = Slot(uri=RDFS.label, name="namedEntity__label", curie=RDFS.curie('label'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.namedEntity__label, domain=None, range=Optional[str])
...
slots.namedEntity__original_spans = Slot(uri=CORE.original_spans, name="namedEntity__original_spans", curie=CORE.curie('original_spans'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.namedEntity__original_spans, domain=None, range=Optional[Union[str, List[str]]],
                   pattern=re.compile(r'^\d+:\d+$'))

slots.triple__subject = Slot(uri=CORE.subject, name="triple__subject", curie=CORE.curie('subject'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.triple__subject, domain=None, range=Optional[Union[str, NamedEntityId]])

slots.triple__predicate = Slot(uri=CORE.predicate, name="triple__predicate", curie=CORE.curie('predicate'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.triple__predicate, domain=None, range=Optional[Union[str, RelationshipTypeId]])

slots.triple__object = Slot(uri=CORE.object, name="triple__object", curie=CORE.curie('object'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.triple__object, domain=None, range=Optional[Union[str, NamedEntityId]])

slots.triple__qualifier = Slot(uri=CORE.qualifier, name="triple__qualifier", curie=CORE.curie('qualifier'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.triple__qualifier, domain=None, range=Optional[str])
...
slots.triple__subject_qualifier = Slot(uri=CORE.subject_qualifier, name="triple__subject_qualifier", curie=CORE.curie('subject_qualifier'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.triple__subject_qualifier, domain=None, range=Optional[Union[str, NamedEntityId]])
...
slots.triple__object_qualifier = Slot(uri=CORE.object_qualifier, name="triple__object_qualifier", curie=CORE.curie('object_qualifier'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.triple__object_qualifier, domain=None, range=Optional[Union[str, NamedEntityId]])
...
slots.textWithTriples__publication = Slot(uri=CORE.publication, name="textWithTriples__publication", curie=CORE.curie('publication'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.textWithTriples__publication, domain=None, range=Optional[Union[dict, Publication]])

slots.textWithTriples__triples = Slot(uri=CORE.triples, name="textWithTriples__triples", curie=CORE.curie('triples'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.textWithTriples__triples, domain=None, range=Optional[Union[Union[dict, Triple], List[Union[dict, Triple]]]])
...
slots.textWithEntity__publication = Slot(uri=CORE.publication, name="textWithEntity__publication", curie=CORE.curie('publication'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.textWithEntity__publication, domain=None, range=Optional[Union[dict, Publication]])

slots.textWithEntity__entities = Slot(uri=CORE.entities, name="textWithEntity__entities", curie=CORE.curie('entities'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.textWithEntity__entities, domain=None, range=Optional[Union[Union[str, NamedEntityId], List[Union[str, NamedEntityId]]]])

slots.publication__id = Slot(uri=CORE.id, name="publication__id", curie=CORE.curie('id'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.publication__id, domain=None, range=Optional[str])

slots.publication__title = Slot(uri=CORE.title, name="publication__title", curie=CORE.curie('title'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.publication__title, domain=None, range=Optional[str])

slots.publication__abstract = Slot(uri=CORE.abstract, name="publication__abstract", curie=CORE.curie('abstract'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.publication__abstract, domain=None, range=Optional[str])
...
slots.publication__combined_text = Slot(uri=CORE.combined_text, name="publication__combined_text", curie=CORE.curie('combined_text'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.publication__combined_text, domain=None, range=Optional[str])

slots.publication__full_text = Slot(uri=CORE.full_text, name="publication__full_text", curie=CORE.curie('full_text'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.publication__full_text, domain=None, range=Optional[str])
...
slots.annotatorResult__subject_text = Slot(uri=CORE.subject_text, name="annotatorResult__subject_text", curie=CORE.curie('subject_text'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.annotatorResult__subject_text, domain=None, range=Optional[str])

slots.annotatorResult__object_id = Slot(uri=CORE.object_id, name="annotatorResult__object_id", curie=CORE.curie('object_id'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.annotatorResult__object_id, domain=None, range=Optional[str])
...
slots.annotatorResult__object_text = Slot(uri=CORE.object_text, name="annotatorResult__object_text", curie=CORE.curie('object_text'),
                   model_uri=SOTON_IBD_MACROSCOPIC_FINDINGS.annotatorResult__object_text, domain=None, range=Optional[str])
