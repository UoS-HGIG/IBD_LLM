# Auto generated from soton_ibd_histology.yaml by pythongen.py version: 0.0.1
# Generation date: 2024-11-20T11:21:05
# Schema: soton_ibd_histology
#
# id: http://w3id.org/ontogpt/soton_ibd_histology
# description: A custom template for extracting and grounding histology reports focused on IBD pathologies.
...
PATHOLOGY = CurieNamespace('pathology', 'http://w3id.org/ontogpt/soton_ibd_histology')
RDF = CurieNamespace('rdf', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#')
RDFS = CurieNamespace('rdfs', 'http://www.w3.org/2000/01/rdf-schema#')
SOTON_IBD_HISTOLOGY = CurieNamespace('soton_ibd_histology', 'http://w3id.org/ontogpt/soton_ibd_histology/')
DEFAULT_ = SOTON_IBD_HISTOLOGY
...
class AnatomicalSubregionsId(NamedEntityId):
    pass
...
class AnatomicalCellularRegionsId(NamedEntityId):
    pass
...
class PathologyReport(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["PathologyReport"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:PathologyReport"
    class_name: ClassVar[str] = "PathologyReport"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.PathologyReport
...
class PathologyStatement(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["PathologyStatement"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:PathologyStatement"
    class_name: ClassVar[str] = "PathologyStatement"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.PathologyStatement
    ...
    anatomical_subregions: Optional[Union[Union[str, AnatomicalSubregionsId], List[Union[str, AnatomicalSubregionsId]]]] = empty_list()
    anatomical_structure: Optional[Union[Union[str, AnatomicalStructuresId], List[Union[str, AnatomicalStructuresId]]]] = empty_list()
    anatomical_cellular_region: Optional[Union[Union[str, AnatomicalCellularRegionsId], List[Union[str, AnatomicalCellularRegionsId]]]] = empty_list()
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.anatomical_subregions, list):
            self.anatomical_subregions = [self.anatomical_subregions] if self.anatomical_subregions is not None else []
        self.anatomical_subregions = [v if isinstance(v, AnatomicalSubregionsId) else AnatomicalSubregionsId(v) for v in self.anatomical_subregions]
        ...
        if not isinstance(self.anatomical_cellular_region, list):
            self.anatomical_cellular_region = [self.anatomical_cellular_region] if self.anatomical_cellular_region is not None else []
        self.anatomical_cellular_region = [v if isinstance(v, AnatomicalCellularRegionsId) else AnatomicalCellularRegionsId(v) for v in self.anatomical_cellular_region]
...
class PatientClinicalHistory(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["PatientClinicalHistory"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:PatientClinicalHistory"
    class_name: ClassVar[str] = "PatientClinicalHistory"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.PatientClinicalHistory
...
class Treatment(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["Treatment"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:Treatment"
    class_name: ClassVar[str] = "Treatment"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.Treatment
...
class PatientDiagnosis(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["PatientDiagnosis"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:PatientDiagnosis"
    class_name: ClassVar[str] = "PatientDiagnosis"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.PatientDiagnosis
...
class ExtractionResult(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.ExtractionResult
...
class NamedEntity(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.NamedEntity
...
class Diagnosis(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["Diagnosis"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:Diagnosis"
    class_name: ClassVar[str] = "Diagnosis"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.Diagnosis
...
class AnatomicalEntity(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["AnatomicalEntity"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:AnatomicalEntity"
    class_name: ClassVar[str] = "AnatomicalEntity"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.AnatomicalEntity
...
@dataclass(repr=False)
class AnatomicalSubregions(NamedEntity):
    _inherited_slots: ClassVar[List[str]] = []

    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["AnatomicalSubregions"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:AnatomicalSubregions"
    class_name: ClassVar[str] = "AnatomicalSubregions"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.AnatomicalSubregions

    id: Union[str, AnatomicalSubregionsId] = None

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(self.id, AnatomicalSubregionsId):
            self.id = AnatomicalSubregionsId(self.id)
...
class AnatomicalStructures(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["AnatomicalStructures"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:AnatomicalStructures"
    class_name: ClassVar[str] = "AnatomicalStructures"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.AnatomicalStructures
...
@dataclass(repr=False)
class AnatomicalCellularRegions(NamedEntity):
    _inherited_slots: ClassVar[List[str]] = []

    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["AnatomicalCellularRegions"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:AnatomicalCellularRegions"
    class_name: ClassVar[str] = "AnatomicalCellularRegions"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.AnatomicalCellularRegions

    id: Union[str, AnatomicalCellularRegionsId] = None

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(self.id, AnatomicalCellularRegionsId):
            self.id = AnatomicalCellularRegionsId(self.id)
...
class ClinicalHistoryEntity(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["ClinicalHistoryEntity"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:ClinicalHistoryEntity"
    class_name: ClassVar[str] = "ClinicalHistoryEntity"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.ClinicalHistoryEntity
...
class ClinicalHistoryLocation(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["ClinicalHistoryLocation"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:ClinicalHistoryLocation"
    class_name: ClassVar[str] = "ClinicalHistoryLocation"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.ClinicalHistoryLocation
...
class TreatmentName(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["TreatmentName"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:TreatmentName"
    class_name: ClassVar[str] = "TreatmentName"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.TreatmentName
...
class TreatmentRoute(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["TreatmentRoute"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:TreatmentRoute"
    class_name: ClassVar[str] = "TreatmentRoute"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.TreatmentRoute
...
class PatientDiagnosisName(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["PatientDiagnosisName"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:PatientDiagnosisName"
    class_name: ClassVar[str] = "PatientDiagnosisName"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.PatientDiagnosisName
...
class PatientDiagnosisLocation(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["PatientDiagnosisLocation"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:PatientDiagnosisLocation"
    class_name: ClassVar[str] = "PatientDiagnosisLocation"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.PatientDiagnosisLocation
...
class Qualifier(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY["Qualifier"]
    class_class_curie: ClassVar[str] = "soton_ibd_histology:Qualifier"
    class_name: ClassVar[str] = "Qualifier"
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.Qualifier
...
class CompoundExpression(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.CompoundExpression
...
class Triple(CompoundExpression):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.Triple
...
class TextWithTriples(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.TextWithTriples
...
class TextWithEntity(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.TextWithEntity
...
class RelationshipType(NamedEntity):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.RelationshipType
...
class Publication(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.Publication
...
class AnnotatorResult(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = SOTON_IBD_HISTOLOGY.AnnotatorResult
...
slots.pathologyReport__pathology_statements = Slot(uri=SOTON_IBD_HISTOLOGY.pathology_statements, name="pathologyReport__pathology_statements", curie=SOTON_IBD_HISTOLOGY.curie('pathology_statements'),
                   model_uri=SOTON_IBD_HISTOLOGY.pathologyReport__pathology_statements, domain=None, range=Optional[Union[Union[dict, PathologyStatement], List[Union[dict, PathologyStatement]]]])

slots.pathologyReport__clinical_history_statements = Slot(uri=SOTON_IBD_HISTOLOGY.clinical_history_statements, name="pathologyReport__clinical_history_statements", curie=SOTON_IBD_HISTOLOGY.curie('clinical_history_statements'),
                   model_uri=SOTON_IBD_HISTOLOGY.pathologyReport__clinical_history_statements, domain=None, range=Optional[Union[Union[dict, PatientClinicalHistory], List[Union[dict, PatientClinicalHistory]]]])

slots.pathologyReport__treatment_statements = Slot(uri=SOTON_IBD_HISTOLOGY.treatment_statements, name="pathologyReport__treatment_statements", curie=SOTON_IBD_HISTOLOGY.curie('treatment_statements'),
                   model_uri=SOTON_IBD_HISTOLOGY.pathologyReport__treatment_statements, domain=None, range=Optional[Union[Union[dict, Treatment], List[Union[dict, Treatment]]]])

slots.pathologyReport__patient_diagnosis_statements = Slot(uri=SOTON_IBD_HISTOLOGY.patient_diagnosis_statements, name="pathologyReport__patient_diagnosis_statements", curie=SOTON_IBD_HISTOLOGY.curie('patient_diagnosis_statements'),
                   model_uri=SOTON_IBD_HISTOLOGY.pathologyReport__patient_diagnosis_statements, domain=None, range=Optional[Union[Union[dict, PatientDiagnosis], List[Union[dict, PatientDiagnosis]]]])

slots.pathologyStatement__diagnosis = Slot(uri=SOTON_IBD_HISTOLOGY.diagnosis, name="pathologyStatement__diagnosis", curie=SOTON_IBD_HISTOLOGY.curie('diagnosis'),
                   model_uri=SOTON_IBD_HISTOLOGY.pathologyStatement__diagnosis, domain=None, range=Optional[Union[str, DiagnosisId]])

slots.pathologyStatement__qualifiers = Slot(uri=SOTON_IBD_HISTOLOGY.qualifiers, name="pathologyStatement__qualifiers", curie=SOTON_IBD_HISTOLOGY.curie('qualifiers'),
                   model_uri=SOTON_IBD_HISTOLOGY.pathologyStatement__qualifiers, domain=None, range=Optional[Union[str, List[str]]])

slots.pathologyStatement__severity = Slot(uri=SOTON_IBD_HISTOLOGY.severity, name="pathologyStatement__severity", curie=SOTON_IBD_HISTOLOGY.curie('severity'),
                   model_uri=SOTON_IBD_HISTOLOGY.pathologyStatement__severity, domain=None, range=Optional[str])

slots.pathologyStatement__anatomical_entities = Slot(uri=SOTON_IBD_HISTOLOGY.anatomical_entities, name="pathologyStatement__anatomical_entities", curie=SOTON_IBD_HISTOLOGY.curie('anatomical_entities'),
                   model_uri=SOTON_IBD_HISTOLOGY.pathologyStatement__anatomical_entities, domain=None, range=Optional[Union[Union[str, AnatomicalEntityId], List[Union[str, AnatomicalEntityId]]]])

slots.pathologyStatement__anatomical_subregions = Slot(uri=SOTON_IBD_HISTOLOGY.anatomical_subregions, name="pathologyStatement__anatomical_subregions", curie=SOTON_IBD_HISTOLOGY.curie('anatomical_subregions'),
                   model_uri=SOTON_IBD_HISTOLOGY.pathologyStatement__anatomical_subregions, domain=None, range=Optional[Union[Union[str, AnatomicalSubregionsId], List[Union[str, AnatomicalSubregionsId]]]])

slots.pathologyStatement__anatomical_structure = Slot(uri=SOTON_IBD_HISTOLOGY.anatomical_structure, name="pathologyStatement__anatomical_structure", curie=SOTON_IBD_HISTOLOGY.curie('anatomical_structure'),
                   model_uri=SOTON_IBD_HISTOLOGY.pathologyStatement__anatomical_structure, domain=None, range=Optional[Union[Union[str, AnatomicalStructuresId], List[Union[str, AnatomicalStructuresId]]]])

slots.pathologyStatement__anatomical_cellular_region = Slot(uri=SOTON_IBD_HISTOLOGY.anatomical_cellular_region, name="pathologyStatement__anatomical_cellular_region", curie=SOTON_IBD_HISTOLOGY.curie('anatomical_cellular_region'),
                   model_uri=SOTON_IBD_HISTOLOGY.pathologyStatement__anatomical_cellular_region, domain=None, range=Optional[Union[Union[str, AnatomicalCellularRegionsId], List[Union[str, AnatomicalCellularRegionsId]]]])

slots.pathologyStatement__negative = Slot(uri=SOTON_IBD_HISTOLOGY.negative, name="pathologyStatement__negative", curie=SOTON_IBD_HISTOLOGY.curie('negative'),
                   model_uri=SOTON_IBD_HISTOLOGY.pathologyStatement__negative, domain=None, range=Optional[str])

slots.patientClinicalHistory__clinical_history = Slot(uri=SOTON_IBD_HISTOLOGY.clinical_history, name="patientClinicalHistory__clinical_history", curie=SOTON_IBD_HISTOLOGY.curie('clinical_history'),
                   model_uri=SOTON_IBD_HISTOLOGY.patientClinicalHistory__clinical_history, domain=None, range=Optional[Union[str, ClinicalHistoryEntityId]])

slots.patientClinicalHistory__clinical_history_severity = Slot(uri=SOTON_IBD_HISTOLOGY.clinical_history_severity, name="patientClinicalHistory__clinical_history_severity", curie=SOTON_IBD_HISTOLOGY.curie('clinical_history_severity'),
                   model_uri=SOTON_IBD_HISTOLOGY.patientClinicalHistory__clinical_history_severity, domain=None, range=Optional[str])

slots.patientClinicalHistory__clinical_history_location = Slot(uri=SOTON_IBD_HISTOLOGY.clinical_history_location, name="patientClinicalHistory__clinical_history_location", curie=SOTON_IBD_HISTOLOGY.curie('clinical_history_location'),
                   model_uri=SOTON_IBD_HISTOLOGY.patientClinicalHistory__clinical_history_location, domain=None, range=Optional[Union[str, ClinicalHistoryLocationId]])

slots.treatment__treatment_name = Slot(uri=SOTON_IBD_HISTOLOGY.treatment_name, name="treatment__treatment_name", curie=SOTON_IBD_HISTOLOGY.curie('treatment_name'),
                   model_uri=SOTON_IBD_HISTOLOGY.treatment__treatment_name, domain=None, range=Optional[Union[str, TreatmentNameId]])

slots.treatment__treatment_route = Slot(uri=SOTON_IBD_HISTOLOGY.treatment_route, name="treatment__treatment_route", curie=SOTON_IBD_HISTOLOGY.curie('treatment_route'),
                   model_uri=SOTON_IBD_HISTOLOGY.treatment__treatment_route, domain=None, range=Optional[Union[str, TreatmentRouteId]])

slots.treatment__treatment_dose = Slot(uri=SOTON_IBD_HISTOLOGY.treatment_dose, name="treatment__treatment_dose", curie=SOTON_IBD_HISTOLOGY.curie('treatment_dose'),
                   model_uri=SOTON_IBD_HISTOLOGY.treatment__treatment_dose, domain=None, range=Optional[str])

slots.treatment__treatment_interval = Slot(uri=SOTON_IBD_HISTOLOGY.treatment_interval, name="treatment__treatment_interval", curie=SOTON_IBD_HISTOLOGY.curie('treatment_interval'),
                   model_uri=SOTON_IBD_HISTOLOGY.treatment__treatment_interval, domain=None, range=Optional[str])

slots.patientDiagnosis__patient_diagnosis_name = Slot(uri=SOTON_IBD_HISTOLOGY.patient_diagnosis_name, name="patientDiagnosis__patient_diagnosis_name", curie=SOTON_IBD_HISTOLOGY.curie('patient_diagnosis_name'),
                   model_uri=SOTON_IBD_HISTOLOGY.patientDiagnosis__patient_diagnosis_name, domain=None, range=Optional[Union[str, PatientDiagnosisNameId]])

slots.patientDiagnosis__patient_diagnosis_severity = Slot(uri=SOTON_IBD_HISTOLOGY.patient_diagnosis_severity, name="patientDiagnosis__patient_diagnosis_severity", curie=SOTON_IBD_HISTOLOGY.curie('patient_diagnosis_severity'),
                   model_uri=SOTON_IBD_HISTOLOGY.patientDiagnosis__patient_diagnosis_severity, domain=None, range=Optional[str])

slots.patientDiagnosis__patient_diagnosis_location = Slot(uri=SOTON_IBD_HISTOLOGY.patient_diagnosis_location, name="patientDiagnosis__patient_diagnosis_location", curie=SOTON_IBD_HISTOLOGY.curie('patient_diagnosis_location'),
                   model_uri=SOTON_IBD_HISTOLOGY.patientDiagnosis__patient_diagnosis_location, domain=None, range=Optional[Union[str, PatientDiagnosisLocationId]])

slots.extractionResult__input_id = Slot(uri=CORE.input_id, name="extractionResult__input_id", curie=CORE.curie('input_id'),
                   model_uri=SOTON_IBD_HISTOLOGY.extractionResult__input_id, domain=None, range=Optional[str])
...
slots.extractionResult__input_title = Slot(uri=CORE.input_title, name="extractionResult__input_title", curie=CORE.curie('input_title'),
                   model_uri=SOTON_IBD_HISTOLOGY.extractionResult__input_title, domain=None, range=Optional[str])
...
slots.extractionResult__input_text = Slot(uri=CORE.input_text, name="extractionResult__input_text", curie=CORE.curie('input_text'),
                   model_uri=SOTON_IBD_HISTOLOGY.extractionResult__input_text, domain=None, range=Optional[str])
...
slots.extractionResult__raw_completion_output = Slot(uri=CORE.raw_completion_output, name="extractionResult__raw_completion_output", curie=CORE.curie('raw_completion_output'),
                   model_uri=SOTON_IBD_HISTOLOGY.extractionResult__raw_completion_output, domain=None, range=Optional[str])

slots.extractionResult__prompt = Slot(uri=CORE.prompt, name="extractionResult__prompt", curie=CORE.curie('prompt'),
                   model_uri=SOTON_IBD_HISTOLOGY.extractionResult__prompt, domain=None, range=Optional[str])
...
slots.extractionResult__extracted_object = Slot(uri=CORE.extracted_object, name="extractionResult__extracted_object", curie=CORE.curie('extracted_object'),
                   model_uri=SOTON_IBD_HISTOLOGY.extractionResult__extracted_object, domain=None, range=Optional[Union[dict, Any]])
...
slots.extractionResult__named_entities = Slot(uri=CORE.named_entities, name="extractionResult__named_entities", curie=CORE.curie('named_entities'),
                   model_uri=SOTON_IBD_HISTOLOGY.extractionResult__named_entities, domain=None, range=Optional[Union[Union[dict, Any], List[Union[dict, Any]]]])

slots.namedEntity__id = Slot(uri=CORE.id, name="namedEntity__id", curie=CORE.curie('id'),
                   model_uri=SOTON_IBD_HISTOLOGY.namedEntity__id, domain=None, range=URIRef)

slots.namedEntity__label = Slot(uri=RDFS.label, name="namedEntity__label", curie=RDFS.curie('label'),
                   model_uri=SOTON_IBD_HISTOLOGY.namedEntity__label, domain=None, range=Optional[str])
...
slots.namedEntity__original_spans = Slot(uri=CORE.original_spans, name="namedEntity__original_spans", curie=CORE.curie('original_spans'),
                   model_uri=SOTON_IBD_HISTOLOGY.namedEntity__original_spans, domain=None, range=Optional[Union[str, List[str]]],
                   pattern=re.compile(r'^\d+:\d+$'))

slots.triple__subject = Slot(uri=CORE.subject, name="triple__subject", curie=CORE.curie('subject'),
                   model_uri=SOTON_IBD_HISTOLOGY.triple__subject, domain=None, range=Optional[Union[str, NamedEntityId]])

slots.triple__predicate = Slot(uri=CORE.predicate, name="triple__predicate", curie=CORE.curie('predicate'),
                   model_uri=SOTON_IBD_HISTOLOGY.triple__predicate, domain=None, range=Optional[Union[str, RelationshipTypeId]])

slots.triple__object = Slot(uri=CORE.object, name="triple__object", curie=CORE.curie('object'),
                   model_uri=SOTON_IBD_HISTOLOGY.triple__object, domain=None, range=Optional[Union[str, NamedEntityId]])

slots.triple__qualifier = Slot(uri=CORE.qualifier, name="triple__qualifier", curie=CORE.curie('qualifier'),
                   model_uri=SOTON_IBD_HISTOLOGY.triple__qualifier, domain=None, range=Optional[str])
...
slots.triple__subject_qualifier = Slot(uri=CORE.subject_qualifier, name="triple__subject_qualifier", curie=CORE.curie('subject_qualifier'),
                   model_uri=SOTON_IBD_HISTOLOGY.triple__subject_qualifier, domain=None, range=Optional[Union[str, NamedEntityId]])
...
slots.triple__object_qualifier = Slot(uri=CORE.object_qualifier, name="triple__object_qualifier", curie=CORE.curie('object_qualifier'),
                   model_uri=SOTON_IBD_HISTOLOGY.triple__object_qualifier, domain=None, range=Optional[Union[str, NamedEntityId]])
...
slots.textWithTriples__publication = Slot(uri=CORE.publication, name="textWithTriples__publication", curie=CORE.curie('publication'),
                   model_uri=SOTON_IBD_HISTOLOGY.textWithTriples__publication, domain=None, range=Optional[Union[dict, Publication]])

slots.textWithTriples__triples = Slot(uri=CORE.triples, name="textWithTriples__triples", curie=CORE.curie('triples'),
                   model_uri=SOTON_IBD_HISTOLOGY.textWithTriples__triples, domain=None, range=Optional[Union[Union[dict, Triple], List[Union[dict, Triple]]]])
...
slots.textWithEntity__publication = Slot(uri=CORE.publication, name="textWithEntity__publication", curie=CORE.curie('publication'),
                   model_uri=SOTON_IBD_HISTOLOGY.textWithEntity__publication, domain=None, range=Optional[Union[dict, Publication]])

slots.textWithEntity__entities = Slot(uri=CORE.entities, name="textWithEntity__entities", curie=CORE.curie('entities'),
                   model_uri=SOTON_IBD_HISTOLOGY.textWithEntity__entities, domain=None, range=Optional[Union[Union[str, NamedEntityId], List[Union[str, NamedEntityId]]]])

slots.publication__id = Slot(uri=CORE.id, name="publication__id", curie=CORE.curie('id'),
                   model_uri=SOTON_IBD_HISTOLOGY.publication__id, domain=None, range=Optional[str])

slots.publication__title = Slot(uri=CORE.title, name="publication__title", curie=CORE.curie('title'),
                   model_uri=SOTON_IBD_HISTOLOGY.publication__title, domain=None, range=Optional[str])

slots.publication__abstract = Slot(uri=CORE.abstract, name="publication__abstract", curie=CORE.curie('abstract'),
                   model_uri=SOTON_IBD_HISTOLOGY.publication__abstract, domain=None, range=Optional[str])
...
slots.publication__combined_text = Slot(uri=CORE.combined_text, name="publication__combined_text", curie=CORE.curie('combined_text'),
                   model_uri=SOTON_IBD_HISTOLOGY.publication__combined_text, domain=None, range=Optional[str])

slots.publication__full_text = Slot(uri=CORE.full_text, name="publication__full_text", curie=CORE.curie('full_text'),
                   model_uri=SOTON_IBD_HISTOLOGY.publication__full_text, domain=None, range=Optional[str])
...
slots.annotatorResult__subject_text = Slot(uri=CORE.subject_text, name="annotatorResult__subject_text", curie=CORE.curie('subject_text'),
                   model_uri=SOTON_IBD_HISTOLOGY.annotatorResult__subject_text, domain=None, range=Optional[str])

slots.annotatorResult__object_id = Slot(uri=CORE.object_id, name="annotatorResult__object_id", curie=CORE.curie('object_id'),
                   model_uri=SOTON_IBD_HISTOLOGY.annotatorResult__object_id, domain=None, range=Optional[str])
...
slots.annotatorResult__object_text = Slot(uri=CORE.object_text, name="annotatorResult__object_text", curie=CORE.curie('object_text'),
                   model_uri=SOTON_IBD_HISTOLOGY.annotatorResult__object_text, domain=None, range=Optional[str])
